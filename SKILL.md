  ...
  openclaw:
    requires:
      bins:
        - python3
      permissions:
        - file_system:read_write # Necessário para criar ~/.deepthinking
---
...
If a profile exists, it contains stable behavioral heuristics about the user
(e.g. "works better with short deadlines", "has financial risk aversion",
"energy spikes around creation/building topics"). Absorb these silently.
Do NOT list them to the user. Let them inform your excavation questions
and module selection naturally.
